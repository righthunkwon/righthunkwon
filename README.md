...
## 1. 경력
```
Misto Holdings 전사 ERP 구축 프로젝트 참여
```

## 2. 경험
`🏢 Misto Holdings (2024-07 ~ ing)` <br/>
`🏫 삼성청년SW아카데미 10기 (2023-07 ~ 2024-06)` <br/>
`🏫 노마드코더 VanillaJS 챌린지 35기 (2023-03 ~ 2023-04)` <br/>
`🏫 한국외국어대학교 (2017-03 ~ 2023-02)` <br/>
`🏫 인프런 제주코딩베이스캠프 서포터즈 3기 (2022-09 ~ 2022-11)` <br/>
<br/>

## 3. 자격/수상
- `리눅스마스터 2급 취득 (2026-01-02)` <br/>
- `삼성청년SW아카데미 자율 프로젝트 결선 입상 (2024-05-28)` <br/>
- `삼성청년SW아카데미 자율 프로젝트 우수상(1위) (2024-05-24)` <br/>
- `삼성청년SW아카데미 공통 프로젝트 우수상(3위) (2024-02-16)` <br/>
- `SQL개발자 취득 (2023-11-18)` <br/><br/> 
